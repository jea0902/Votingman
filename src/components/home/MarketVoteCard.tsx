...
const POLL_QUESTION: Record<string, string> = {
  ...
  eth_1d: "1일 후 이더리움(ETH) 가격 방향을 어떻게 보시나요?",
  eth_4h: "4시간 후 이더리움(ETH) 가격 방향을 어떻게 보시나요?",
  eth_1h: "1시간 후 이더리움(ETH) 가격 방향을 어떻게 보시나요?",
  eth_15m: "15분 후 이더리움(ETH) 가격 방향을 어떻게 보시나요?",
  eth_5m: "5분 후 이더리움(ETH) 가격 방향을 어떻게 보시나요?",
  usdt_1d: "1일 후 테더(USDT) 가격 방향을 어떻게 보시나요?",
  usdt_4h: "4시간 후 테더(USDT) 가격 방향을 어떻게 보시나요?",
  usdt_1h: "1시간 후 테더(USDT) 가격 방향을 어떻게 보시나요?",
  usdt_15m: "15분 후 테더(USDT) 가격 방향을 어떻게 보시나요?",
  usdt_5m: "5분 후 테더(USDT) 가격 방향을 어떻게 보시나요?",
  xrp_1d: "1일 후 리플(XRP) 가격 방향을 어떻게 보시나요?",
  xrp_4h: "4시간 후 리플(XRP) 가격 방향을 어떻게 보시나요?",
  xrp_1h: "1시간 후 리플(XRP) 가격 방향을 어떻게 보시나요?",
  xrp_15m: "15분 후 리플(XRP) 가격 방향을 어떻게 보시나요?",
  xrp_5m: "5분 후 리플(XRP) 가격 방향을 어떻게 보시나요?",
  ndq_1d: "1일 후 나스닥100 지수(NDQ)의 가격 방향을 어떻게 보시나요?",
  ndq_4h: "4시간 후 나스닥100 지수(NDQ)의 가격 방향을 어떻게 보시나요?",
  sp500_1d: "1일 후 S&P500 지수(SPX)의 가격 방향을 어떻게 보시나요?",
  sp500_4h: "4시간 후 S&P500 지수(SPX)의 가격 방향을 어떻게 보시나요?",
  kospi_1d: "1일 후 코스피 지수(KOSPI)의 가격 방향을 어떻게 보시나요?",
  kospi_1h: "1시간 후 코스피 지수(KOSPI)의 가격 방향을 어떻게 보시나요?",
  kosdaq_1d: "1일 후 코스닥 지수(KOSDAQ)의 가격 방향을 어떻게 보시나요?",
  kosdaq_1h: "1시간 후 코스닥 지수(KOSDAQ)의 가격 방향을 어떻게 보시나요?",
  samsung_1d: "1일 후 삼성전자(005930) 주가 방향을 어떻게 보시나요?",
  samsung_1h: "1시간 후 삼성전자(005930) 주가 방향을 어떻게 보시나요?",
  skhynix_1d: "1일 후 SK하이닉스(000660) 주가 방향을 어떻게 보시나요?",
  skhynix_1h: "1시간 후 SK하이닉스(000660) 주가 방향을 어떻게 보시나요?",
  hyundai_1d: "1일 후 현대자동차(005380) 주가 방향을 어떻게 보시나요?",
  hyundai_1h: "1시간 후 현대자동차(005380) 주가 방향을 어떻게 보시나요?",
  dow_jones_1d: "1일 후 다우존스 지수의 가격 방향을 어떻게 보시나요?",
  dow_jones_4h: "4시간 후 다우존스 지수의 가격 방향을 어떻게 보시나요?",
  wti_1d: "1일 후 WTI(원유) 가격 방향을 어떻게 보시나요?",
  wti_4h: "4시간 후 WTI(원유) 가격 방향을 어떻게 보시나요?",
  xau_1d: "1일 후 금(XAU/USD) 가격 방향을 어떻게 보시나요?",
  xau_4h: "4시간 후 금(XAU/USD) 가격 방향을 어떻게 보시나요?",
  shanghai_1d: "1일 후 상해종합지수 가격 방향을 어떻게 보시나요?",
  shanghai_4h: "4시간 후 상해종합지수 가격 방향을 어떻게 보시나요?",
  nikkei_1d: "1일 후 니케이225 가격 방향을 어떻게 보시나요?",
  nikkei_4h: "4시간 후 니케이225 가격 방향을 어떻게 보시나요?",
  eurostoxx50_1d: "1일 후 유로스톡스50 가격 방향을 어떻게 보시나요?",
  eurostoxx50_4h: "4시간 후 유로스톡스50 가격 방향을 어떻게 보시나요?",
  hang_seng_1d: "1일 후 항셍지수 가격 방향을 어떻게 보시나요?",
  hang_seng_4h: "4시간 후 항셍지수 가격 방향을 어떻게 보시나요?",
  usd_krw_1d: "1일 후 USD/KRW 환율 방향을 어떻게 보시나요?",
  usd_krw_4h: "4시간 후 USD/KRW 환율 방향을 어떻게 보시나요?",
  jpy_krw_1d: "1일 후 JPY/KRW 환율 방향을 어떻게 보시나요?",
  jpy_krw_4h: "4시간 후 JPY/KRW 환율 방향을 어떻게 보시나요?",
  usd10y_1d: "1일 후 미국 10년물 국채 금리 방향을 어떻게 보시나요?",
  usd10y_4h: "4시간 후 미국 10년물 국채 금리 방향을 어떻게 보시나요?",
  usd30y_1d: "1일 후 미국 30년물 국채 금리 방향을 어떻게 보시나요?",
  usd30y_4h: "4시간 후 미국 30년물 국채 금리 방향을 어떻게 보시나요?",
};
