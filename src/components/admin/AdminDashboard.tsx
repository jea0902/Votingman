 ...
 * - 미정산 투표 무효 처리 (Binance API 장애 대응)
 * - 새로고침 버튼, 60초 자동 갱신
 */
import { useState, useEffect, useCallback } from "react";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
import { Button } from "@/components/ui/button";
import { Users, RefreshCw, Loader2, UserPlus, Vote, Eye, UserCheck, AlertTriangle, Database } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <Button
        variant="outline"
        size="sm"
        onClick={() => { fetchStats(); fetchUnsettledPolls(); }}
        disabled={isLoading}
      >
          ...
          {aggregateResetNeeded.length > 0 && (
            <>
              ...
              >
                ...
                <span className={cn(isInvalidating && "ml-2")}>
                  {isInvalidating
                    ? "처리 중..."
